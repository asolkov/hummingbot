...
class OkxPerpetualDemoConfigMap(BaseConnectorConfigMap):
    ...
    okx_perpetual_demo_api_key: SecretStr = Field(
        default=...,
        json_schema_extra={
            "prompt": "Enter your Okx Perpetual Demo API key",
            "is_secure": True,
            "is_connect_key": True,
            "prompt_on_new": True,
        }
    ...
    okx_perpetual_demo_secret_key: SecretStr = Field(
        default=...,
        json_schema_extra={
            "prompt": "Enter your Okx Perpetual Demo secret key",
            "is_secure": True,
            "is_connect_key": True,
            "prompt_on_new": True,
        }
    ...
    okx_perpetual_demo_passphrase: SecretStr = Field(
        default=...,
        json_schema_extra={
            "prompt": "Enter your Okx Perpetual Demo passphrase",
            "is_secure": True,
            "is_connect_key": True,
            "prompt_on_new": True,
        }
...
# Sub-domain registration for demo trading
